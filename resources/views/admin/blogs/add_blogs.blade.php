                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('store.blog') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="blog_category_id" class="form-select"
                                            ...
                                            {{-- Looping over to get the categories of the blogs from a different table.  --}}
                                            <option selected="">Open this select menu</option>
                                            @foreach ($categories as $cat)
                                                {{--
                                                    in the value section we pass in the ID - {{ $cat->id }}
                                                    IN THE NAME SECTION WE PASS IN THE CATEGORY NAME - {{ $cat->blog_category }}
                                                    <option value="1">React Native</option>
                                                <option value="1">React Native</option> --}}
                                ...
                                <div class="row mb-3">
                                    {{-- Tags input cdn. Pin the js and css. BOOTSRAP INPUT --}}
