        ...
        <div class="row align-items-center justify-content-center justify-content-lg-between">
            ...
            <div class="col-xl-5 col-lg-6">
                <div class="banner__content">
                    <h4>Hi, My Name is</h4>
                    <h3 class="wow fadeInUp"><span>Emmanuel Mukhebi</h3>
                    ...
                    <a href="{{ route('home.about') }}" class="btn banner__btn wow fadeInUp" data-wow-delay=".4s">more about me</a>
                </div>
            </div>
        </div>
    </div>
