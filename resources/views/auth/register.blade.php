...
<form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
 ...
 <div class ="custom-control custom-checkbox">
    ...
    <label class="form-check-label ms-1 fw-normal" for="exampleCheck1">I Accept
    ...
    <div class="form-group mt-2 mb-0 row">
        <div class="col-12 mt-3 text-center">
            <p class="text-muted">Already have account? <a href="{{ route('login') }}" class="text-capitalize font-weight-bold">Login</a></p>
